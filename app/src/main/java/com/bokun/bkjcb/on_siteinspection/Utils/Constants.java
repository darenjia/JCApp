...
public class Constants {
    ...
    * */
    ...
    public static final String HTTPURL = "http://183.194.241.115:9003/zgzxjkWebService.asmx";
    public static final String FTP_HOST_DEFAULT = "183.194.241.114";//"43.254.152.169";
